...
/**
 * InvalidGetterAnnotationAspect is responsible for ...
 */
@Aspect
public class InvalidGetterAnnotationAspect extends AjUnitBeforeAnnotationAspect {
    @Pointcut("execution(public (void || *[] || *[][] || java.util.Collection+ || java.util.Map+) get*()) " +
            "|| execution(public * get*(*,..)) " +
            "|| execution(public * get*() throws java.lang.Throwable+)" )
